<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="think.pages.Home" %>
    ...
    <%@ Register Src="~/template/HomeNav.ascx" TagName="Navbar" TagPrefix="Head" %>
        ...
        <body>
            <Head:Navbar ID="nav" runat="server" />
            <section id="homeSection">
                <div id="homeLeft" class="homeChilds">
                    ...
                    <button id="openSignup" class="themeBtn">Create a student account</button>
                </div>
                <div id="homeRight" class="homeChilds">
                    <img src="../assets/home.png" alt="Home" id="homeImage">
                    <form id="login" class="forms">
                        <p>Login</p>
                        <input type="text" name="loginEmail" id="loginEmail" class="inputs" placeholder="Email">
                        <input type="password" name="password" id="loginPassword" class="inputs" placeholder="Password"
                            autocomplete="false">
                    ...
                    <form id="signup" class="forms">
                        ...
                        <input type="password" name="password" id="password" class="inputs" placeholder="Password"
                            autocomplete="false">
                        <input type="password" name="confirmPass" id="confirmPass" class="inputs"
